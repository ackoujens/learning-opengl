...
class FragmentShader : public Engine {
private:
...
public:
    ...
    void startup() {
      ...
      static const GLchar * fragmentShaderSource[] =
      {
        ...
        "                                              \n"
        "void main(void) {                             \n"
            // FragCoord contains the position of the fragment within the window
            // Color of each pixel is now a function of it's position
        "   color = vec4(sin(gl_FragCoord.x * 0.25) * 0.5 + 0.5, \n"
        "                 cos(gl_FragCoord.y * 0.25) * 0.5 + 0.5, \n"
        "                 sin(gl_FragCoord.z * 0.25) * cos(gl_FragCoord.y * 0.15), \n"
        "                 1.0);                         \n"
        "}                                             \n"
      };
